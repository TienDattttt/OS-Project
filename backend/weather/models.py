...
class NotificationSetting(models.Model):
    user = models.OneToOneField('UserProfile', on_delete=models.CASCADE, related_name='notification_setting')
    notify_rain = models.BooleanField(default=False)  # Thông báo nếu sắp mưa
    notify_low_temp = models.BooleanField(default=False)  # Thông báo nếu nhiệt độ dưới 20°C
    notify_high_temp = models.BooleanField(default=False)  # Thông báo nếu nhiệt độ trên 35°C
    updated_at = models.DateTimeField(auto_now=True)
...
class UserProfile(AbstractUser):
    ...
    confirmation_token = models.CharField(max_length=36, null=True, blank=True)
